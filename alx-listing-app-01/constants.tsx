...
export const BathIcon = ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 12h5M9 12H4M9 12a5 5 0 01-5-5V4h16v3a5 5 0 01-5 5zm0 0v6a2 2 0 01-2 2H6a2 2 0 01-2-2v-6m12 0v6a2 2 0 002 2h2a2 2 0 002-2v-6" /></svg>
);
...
export const listings: Listing[] = [
    {
        ...
        images: ['https://picsum.photos/seed/1/800/600', 'https://picsum.photos/seed/2/800/600', 'https://picsum.photos/seed/3/800/600'],
        rating: 4.76,
        price: 2450,
        tags: ['Top Villa', 'Self Checkin', 'Free Reschedule'],
        details: { beds: 4, baths: 2, guests: 4 },
        discount: 60,
    },
    {
        id: 2,
        ...
        images: ['https://picsum.photos/seed/4/800/600', 'https://picsum.photos/seed/5/800/600'],
        rating: 4.76,
        price: 62,
        tags: ['Top Villa', 'Self Checkin', 'Free Reschedule'],
        details: { beds: 1, baths: 1, guests: 3 },
    },
    {
        id: 3,
        title: 'Earthen home',
        location: 'Santa Marta, Colombia',
        images: ['https://picsum.photos/seed/6/800/600', 'https://picsum.photos/seed/7/800/600', 'https://picsum.photos/seed/8/800/600'],
        rating: 4.76,
        price: 386,
        tags: ['Top Villa', 'Self Checkin', 'Free Reschedule'],
        details: { beds: 4, baths: 2, guests: 6 },
    },
    {
        id: 4,
        title: 'Private room',
        location: 'Moeda, Brazil',
        images: ['https://picsum.photos/seed/9/800/600', 'https://picsum.photos/seed/10/800/600'],
        rating: 4.76,
        price: 134,
        tags: ['Top Villa', 'Self Checkin', 'Free Reschedule'],
    ...
    },
    {
        ...
        images: ['https://picsum.photos/seed/11/800/600', 'https://picsum.photos/seed/12/800/600'],
        rating: 4.76,
        price: 980,
        tags: ['Top Villa', 'Self Checkin', 'Free Reschedule'],
        details: { beds: 5, baths: 5, guests: 10 },
    },
    {
        id: 6,
        title: 'Luxury 1000 sqm Villa...',
        location: 'Marrakech, Morocco',
        images: ['https://picsum.photos/seed/13/800/600', 'https://picsum.photos/seed/14/800/600', 'https://picsum.photos/seed/15/800/600'],
        rating: 4.76,
        price: 1430,
        tags: ['Top Villa', 'Self Checkin', 'Free Reschedule'],
        details: { beds: 6, baths: 6, guests: 12 },
    },
    {
        id: 7,
        title: 'Palais Hassoun Marrakech',
        location: 'Marrakech, Morocco',
        images: ['https://picsum.photos/seed/16/800/600', 'https://picsum.photos/seed/17/800/600'],
        rating: 4.76,
        price: 3450,
        tags: ['Top Villa', 'Self Checkin', 'Free Reschedule'],
        details: { beds: 13, baths: 13, guests: 26 },
    },
    {
        id: 8,
        title: 'Villa Lamp',
        location: 'Benahavis, Spain',
        images: ['https://picsum.photos/seed/18/800/600', 'https://picsum.photos/seed/19/800/600', 'https://picsum.photos/seed/20/800/600'],
        rating: 4.76,
        price: 2041,
        tags: ['Top Villa', 'Self Checkin', 'Free Reschedule'],
        details: { beds: 7, baths: 7, guests: 12 },
    },
    {
        id: 9,
        title: 'Villa l\'Oui d\'Or',
        location: 'Marrakech, Morocco',
        images: ['https://picsum.photos/seed/21/800/600', 'https://picsum.photos/seed/22/800/600'],
        rating: 4.76,
        price: 1009,
        tags: ['Top Villa', 'Self Checkin', 'Free Reschedule'],
        details: { beds: 8, baths: 7, guests: 14 },
    },
    {
        id: 10,
        title: 'Designer villa, pool not ...',
        location: 'Marrakech, Morocco',
        images: ['https://picsum.photos/seed/23/800/600', 'https://picsum.photos/seed/24/800/600', 'https://picsum.photos/seed/25/800/600'],
        rating: 4.76,
        price: 1289,
        tags: ['Top Villa', 'Self Checkin', 'Free Reschedule'],
        details: { beds: 6, baths: 6, guests: 12 },
    },
    {
        ...
        images: ['https://picsum.photos/seed/26/800/600', 'https://picsum.photos/seed/27/800/600'],
        rating: 4.76,
        price: 1692,
        tags: ['Top Villa', 'Self Checkin', 'Free Reschedule'],
        details: { beds: 6, baths: 7, guests: 12 },
    },
    {
        id: 12,
        title: 'Riad Mayo & Bungalows',
        location: 'Sidi Abdallah Ghiat, Morocco',
        images: ['https://picsum.photos/seed/28/800/600', 'https://picsum.photos/seed/29/800/600', 'https://picsum.photos/seed/30/800/600'],
        rating: 4.76,
        price: 865,
        tags: ['Top Villa', 'Self Checkin', 'Free Reschedule'],
        details: { beds: 21, baths: 18, guests: 16 },
    },
     {
        id: 13,
        title: 'Casa de Carolina',
        location: 'Playas de Vera, Spain',
        images: ['https://picsum.photos/seed/31/800/600', 'https://picsum.photos/seed/32/800/600'],
        rating: 4.76,
        price: 215,
        tags: ['Top Villa', 'Self Checkin', 'Free Reschedule'],
        details: { beds: 1, baths: 1, guests: 4 },
    },
    {
        id: 14,
        title: 'Happy Valley Villa, Tuni...',
        location: 'Qaroun, Egypt',
        images: ['https://picsum.photos/seed/33/800/600', 'https://picsum.photos/seed/34/800/600', 'https://picsum.photos/seed/35/800/600'],
        rating: 4.76,
        price: 100,
        tags: ['Top Villa', 'Self Checkin', 'Free Reschedule'],
        details: { beds: 7, baths: 3, guests: 8 },
    },
    {
        id: 15,
        title: 'Almyros Residence',
        location: 'Lasithi, Greece',
        images: ['https://picsum.photos/seed/36/800/600', 'https://picsum.photos/seed/37/800/600'],
        rating: 4.76,
        price: 747,
        tags: ['Top Villa', 'Self Checkin', 'Free Reschedule'],
        details: { beds: 6, baths: 4, guests: 10 },
    },
    {
        id: 16,
        title: 'Villa White Stone mode...',
        location: 'Marrakech, Morocco',
        images: ['https://picsum.photos/seed/38/800/600', 'https://picsum.photos/seed/39/800/600', 'https://picsum.photos/seed/40/800/600'],
        rating: 4.76,
        price: 1798,
        tags: ['Top Villa', 'Self Checkin', 'Free Reschedule'],
        details: { beds: 7, baths: 6, guests: 12 },
    }
];
